...
k = 15 if X_vt.shape[1] > 15 else X_vt.shape[1]  # không chọn quá nhiều nếu số feature ít
...
filename = 'preprocessed_data_v7.pkl'
joblib.dump(
    (X_train, X_val, X_test, y_train, y_val, y_test, selected_columns, vt, selector),
    filename
)
print(f"Preprocessing done. Saved as '{filename}'.")
